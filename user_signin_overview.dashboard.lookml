- dashboard: user_sign_in_overview
  ...
  - title: Sign Ins by Status Over Time
    ...
    type: looker_line
    fields: [udm_events__security_result.security_result_action_as_string, udm_events.count,
      udm_events.event_timestamp_date]
    ...
    y_axes: [{label: Events Count, orientation: left, series: [{axisId: ALLOW - udm_events.count,
            id: ALLOW - udm_events.count, name: Successful}, {axisId: BLOCK - udm_events.count,
            id: BLOCK - udm_events.count, name: Failed}], showLabels: true, showValues: true,
        unpinAxis: false, tickDensity: default, tickDensityCustom: 5, type: linear}]
    x_axis_label: Date
    hidden_series: []
    series_types: {}
    series_labels:
      ALLOW - udm_events.count: Successful
      BLOCK - udm_events.count: Failed
    ordering: none
    show_null_labels: false
    show_totals_labels: false
    show_silhouette: false
  ...
  - title: Number Of Successful Logins
    ...
    dynamic_fields: [{table_calculation: delta, label: Delta, expression: 'round(if(is_null(${udm_events.count}),
          0, ${udm_events.count}) - offset(if(is_null(${udm_events.count}), 0, ${udm_events.count}),
    ...
    note_display: hover
    note_text: Delta compared to the previous time period
    listen:
      Time: udm_events.period_filter
    row: 0
    col: 6
  ...
  - title: Sign Ins By Application
    ...
    filters:
      ...
      udm_events.period: This Period
      udm_events__security_result.security_result_action_as_string: "-NULL"
    sorts: [udm_events.count desc 0, udm_events__target.application, udm_events__security_result.security_result_action_as_string]
    limit: 100
    query_timezone: America/Los_Angeles
    show_view_names: false
    ...
    series_labels:
      ...
      udm_events__target.application: Application Name
      udm_events__security_result.security_result_action_as_string: Result
  ...
  - title: Sign In Location Map
    ...
    defaults_version: 1
    listen:
      Time: user_login_source_geo_ip.period_filter
    row: 21
    col: 8
    width: 7
    height: 7
  - title: Top 10 Users by Sign In Status
    ...
    explore: udm_events
    type: looker_grid
    fields: [udm_events__principal__user.userid_for_drill, udm_events__security_result.security_result_action_as_string,
    ...
    filters:
      ...
      udm_events__security_result.security_result_action_as_string: "-NULL"
      udm_events.period: This Period
    sorts: [udm_events__security_result.security_result_action_as_string 0, udm_events.count
        desc 1]
    limit: 30
    query_timezone: America/Los_Angeles
    show_view_names: false
    ...
    series_labels:
      udm_events__principal__user.userid_for_drill: User Id
      udm_events__principal.ip: Source IP
      udm_events.count: Events Count
      udm_events__security_result.security_result_action_as_string: Status
    series_cell_visualizations:
      udm_events.count:
        is_active: true
    limit_displayed_rows_values:
    ...
    conditional_formatting: [{type: along a scale..., value: !!null '', background_color: "#3EB0D5",
        ...
        bold: false, italic: false, strikethrough: false, fields: [udm_events.count]},
