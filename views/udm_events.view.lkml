...
###################################################
view: events_mapping_product_type_as_string_core {
  derived_table: {
    sql: SELECT
        udm_enum_value_to_name_mapping.enum_value  AS udm_enum_value_to_name_mapping_enum_value,
        udm_enum_value_to_name_mapping.enum_name  AS udm_enum_value_to_name_mapping_enum_name
      FROM `@{DATASET_NAME}.@{UDM_MAPPINGS}`
           AS udm_enum_value_to_name_mapping

      WHERE
        (udm_enum_value_to_name_mapping.field_path = 'backstory.Metadata.EventType');;
  }

  dimension: udm_enum_value_to_name_mapping_enum_value {
    hidden: yes   
    type: number
    sql: ${TABLE}.udm_enum_value_to_name_mapping_enum_value ;;
  }

  dimension: udm_enum_value_to_name_mapping_enum_name {
    label: "metadata.event_type.string"
    type: string
    sql: ${TABLE}.udm_enum_value_to_name_mapping_enum_name ;;
  }
